...
public interface IOption extends IProduct {
     ...
     *
     * @throws com.atgrand.functional.error.NoSuchElementError If the option is not defined.
     */
    function get get():*
     ...
     */
    function getOrElse(f:Function/*.<→ A>*/):*
     ...
     */
    function filter(f:Function/*.<A → Boolean>*/):IOption
     ...
     */
    function flatMap/*.<B>*/(f:Function/*.<A → IOption.<B>>*/):IOption
     ...
     */
    function map/*.<B>*/(f:Function/*.<A → B>*/):IOption
     ...
     */
    function orElse(f:Function/*.<→ A>*/):IOption
